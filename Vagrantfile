...
config.vm.define "pat4" do |pat4|
  pat4.vm.box = OS
  pat4.vm.network "private_network", ip: PAT4
  pat4.vm.hostname = "pat4"
  pat4.vm.provision "file", source: "~/.ssh/id_rsa.pub", destination: "~/.ssh/id_rsa.pub"
  pat4.vm.provision "shell", inline: <<-SHELL
    cat /home/vagrant/.ssh/id_rsa.pub >> /home/vagrant/.ssh/authorized_keys
SHELL
end

config.vm.define "pgb1" do |pgb1|
  pgb1.vm.box = OS
  pgb1.vm.network "private_network", ip: PGB1
  pgb1.vm.hostname = "pgb1"
  pgb1.vm.provision "file", source: "~/.ssh/id_rsa.pub", destination: "~/.ssh/id_rsa.pub"
  pgb1.vm.provision "shell", inline: <<-SHELL
    cat /home/vagrant/.ssh/id_rsa.pub >> /home/vagrant/.ssh/authorized_keys
SHELL
end

config.vm.define "pgb2" do |pgb2|
  pgb2.vm.box = OS
  pgb2.vm.network "private_network", ip: PGB2
  pgb2.vm.hostname = "pgb2"
  pgb2.vm.provision "file", source: "~/.ssh/id_rsa.pub", destination: "~/.ssh/id_rsa.pub"
  pgb2.vm.provision "shell", inline: <<-SHELL
    cat /home/vagrant/.ssh/id_rsa.pub >> /home/vagrant/.ssh/authorized_keys
SHELL
end
...
config.vm.define "hap" do |hap|
  ...
  hap.vm.network "forwarded_port", guest: 3000, host: 32700
  hap.vm.network "forwarded_port", guest: 7000, host: 7000
  hap.vm.network "forwarded_port", guest: 6432, host: 6432
  hap.vm.hostname = "hap"
